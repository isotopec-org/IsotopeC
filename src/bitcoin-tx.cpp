...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s isotopec-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  isotopec-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded IsotopeC transaction") + "\n" +
              "  isotopec-tx [options] -create [commands]   " + _("Create hex-encoded IsotopeC transaction") + "\n" +
              "\n";
