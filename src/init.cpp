...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/isotopec-org/IsotopeC>";
    const std::string URL_WEBSITE = "<https://isotopec.org>";

    return CopyrightHolders(strprintf(_("Copyright (C) %i-%i"), 2009, COPYRIGHT_YEAR) + " ") + "\n" +
           strprintf(_("Copyright (C) %i IsotopeC Development Labs"), COPYRIGHT_YEAR) + "\n" +
           "\n" +
